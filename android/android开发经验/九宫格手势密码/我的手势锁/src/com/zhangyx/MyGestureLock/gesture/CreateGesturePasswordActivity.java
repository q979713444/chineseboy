...
import com.zhangyx.MyGestureLock.view.LockPatternView.DisplayMode;
...
/***
 * 创建手势锁
 *com.zhangyx.MyGestureLock.gesture.CreateGesturePasswordActivity
 * @author Admin-zhangyx
 *
 * create at 2015-1-16 下午3:08:48
 */
public class CreateGesturePasswordActivity extends BaseActivity implements
	...
	enum RightButtonMode {//继续|确定
		Continue(R.string.lockpattern_continue_button_text, true), ContinueDisabled(
				...
				R.string.lockpattern_confirm_button_Know, true);
		//android.R.string.ok
		/**
		 * @param text
		 *            The displayed text for this mode.
	...
	private void saveChosenPatternAndFinish() {
		...
		showToast(this.getString(R.string.toastSetPedSucces));
