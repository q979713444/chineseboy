...
public class PushService2 extends Service {
	...
	private static final String MQTT_HOST = "192.168.2.109";
	...
	private void startKeepAlives() {
		Intent i = new Intent();
		i.setClass(this, PushService2.class);
		i.setAction(ACTION_KEEPALIVE);
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public MQTTConnection(String brokerHostName, String initTopic)
			...
			mqttClient = MqttClient.createMqttClient(mqttConnSpec,
					MQTT_PERSISTENCE);
			String clientID = (System.currentTimeMillis()) + "";// UUID.randomUUID().toString();//MQTT_CLIENT_ID
																// + "/"+
			...
			// initTopic = "finance/stock/ibm/#";
			String[] topics = { "jky/appName/version/token",
					"jky/appName/version", "jky/appName", "jky" };
			subscribeToTopic(topics);

			log("Connection established to " + brokerHostName + " on topic "
					+ initTopic);
			Looper.prepare();
			Toast.makeText(PushService2.this, "connect success",
