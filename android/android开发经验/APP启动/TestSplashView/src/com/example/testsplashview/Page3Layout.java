...
public class Page3Layout extends FrameLayout
{
  ...
  public Page3Layout(Context paramContext)
  {
    this(paramContext, null, 0);
  }

  public Page3Layout(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }

  public Page3Layout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    setWillNotDraw(false);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    BitmapFactory.decodeResource(getResources(), R.drawable.image_xiaocaiqi_right, localOptions);
    xiaocaiqiHeight = localOptions.outHeight;
    xiaocaiqiWidth = localOptions.outWidth;
    localOptions.inSampleSize = 2;
    localOptions.inJustDecodeBounds = false;
    mXiaocaiqi = BitmapFactory.decodeResource(getResources(), R.drawable.image_xiaocaiqi_right, localOptions);
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    mXiaocaiqiSrc = new Rect(0, (int)(xiaocaiqiNewHeight + mTranslationY / mScaleNum), xiaocaiqiNewWidth, (int)(xiaocaiqiNewHeight + (mTranslationY - mScreenHeight) / mScaleNum));
